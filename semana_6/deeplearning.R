...
spiral <- h2o.importFile(path = normalizePath("C:/Users/admin/Desktop/spiral.csv"))
grid   <- h2o.importFile(path = normalizePath("C:/Users/admin/Desktop/grid.csv"))
...
#
df <- h2o.importFile(path = normalizePath("C:/Users/admin/Desktop/covtype.full.csv"))
dim(df)
df
